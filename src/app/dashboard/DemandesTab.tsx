...
import { Inbox, Loader2, Mail, Phone, MapPin } from "lucide-react";
...
/**
 * Onglet dashboard "Demandes reçues" — issu du parcours PROLOCAL AI
 * (recherche en langage naturel → demande de devis). N'affiche que des
 * demandes réellement créées via /api/demandes, jamais de données générées.
 */
export default function DemandesTab({ proId }: { proId: string }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-gray-500 mb-4">
        Demandes de devis ou de contact envoyées via la recherche PROLOCAL AI.
      </p>
